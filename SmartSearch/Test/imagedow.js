...
const MApp = () => {
  ...
  const uploadImage = async () => {
    ...
    try {
      const response = await axios.post('https://db-hosting-sql-resq.vercel.app/api/v1/posts/send', formData, {
        headers: {
  ...
  const getImage = async () => {
    ...
    try {
      const response = await axios.get(`https://db-hosting-sql-resq.vercel.app/api/v1/posts/get/1`);
